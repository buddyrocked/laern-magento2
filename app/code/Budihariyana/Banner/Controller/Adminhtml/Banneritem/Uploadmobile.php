 ...
 * Class Upload
 */
class Uploadmobile extends \Magento\Backend\App\Action
{
    /**
     * Image uploader
     *
    ...
    public function __construct(
        ...
        $this->imageMobileUploader = $imageUploader;
    }
    ...
    {
        try {
            $result = $this->imageMobileUploader->saveFileToTmpDir('image_mobile');
